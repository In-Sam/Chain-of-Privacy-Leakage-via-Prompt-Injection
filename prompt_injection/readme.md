...
The bridging technique is used to make the user prompt and the external benign content appear as a single continuous instruction. This may cause the model to overlook parts of the original request and follow the injected intent instead.
